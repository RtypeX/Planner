...
// Vite-friendly Link shim — original component used next/link.
// In a non-Next app, just render a plain anchor.
...
export const SignInPage = ({ className, onSubmitEmail, onSubmitCode, onSuccess }: SignInPageProps) => {
